...
class Settings(BaseSettings):
    ...
    # Bytes of the raw file sent to the model (head/middle/tail excerpt). Small
    # on purpose: a few dozen lines teach a format, and 64 KiB of a repetitive
    # log was ~50k tokens of prompt that a local model could not finish in time.
    converter_sample_bytes: int = Field(default=4096, ge=1024, le=1048576)
