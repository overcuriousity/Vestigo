    ...
    >
      <div className="flex items-center gap-2 border-b border-[var(--color-border)]/60 px-3 py-1.5">
        <button
          ...
          className="cursor-grab rounded p-0.5 text-[var(--color-fg-muted)] opacity-0 transition-opacity hover:bg-[var(--color-bg-hover)] group-hover/block:opacity-100"
          {...(handleProps ?? {})}
        >
        ...
        <Button
          ...
          className="h-6 w-6 opacity-0 group-hover/block:opacity-100"
          onClick={onDelete}
        >
