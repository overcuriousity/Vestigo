...
`converter_max_attempts` (4), `converter_sample_bytes` (64 KiB — the ceiling on what is
sent, after the excerpt is condensed to distinct line shapes; a repetitive log sends far
less),
